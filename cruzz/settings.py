"""
Django settings for cruzz project.
...
PWA_SERVICE_WORKER_PATH = os.path.join(BASE_DIR, 'cruzz/static/js', 'serviceworker.js')
...
WSGI_APPLICATION = 'cruzz.wsgi.application'
